defmodule Canopy.JTBD.YAWLv6Simulation do
  ...
  @modules [
    ...
    %{
      ...
      start_iteration: 21, complete_iteration: 33,
      phase: :services
    },
    %{
      name: "workletService",
      ...
      known_issues: [],
      start_iteration: 34, complete_iteration: 43,
      phase: :services
    },
    %{
      name: "monitorService",
      ...
      start_iteration: 44, complete_iteration: 68,
      phase: :services
    },
    %{
      name: "costService",
      ...
      known_issues: [],
      start_iteration: 69, complete_iteration: 78,
      phase: :services
    },
    %{
      name: "mailService",
      ...
      start_iteration: 79, complete_iteration: 93,
      phase: :services
    },
    %{
      name: "mailSender",
      ...
      known_issues: [],
      start_iteration: 94, complete_iteration: 103,
      phase: :services
    },
    %{
      ...
      tests: 45, passing: 45, failures: 0,
      known_issues: [],
      start_iteration: 104, complete_iteration: 110,
      phase: :services
    },
    ...
    %{
      ...
      start_iteration: 111, complete_iteration: 120,
      phase: :monitoring
    },
    %{
      ...
      known_issues: [],
      start_iteration: 121, complete_iteration: 128,
      phase: :monitoring
    },
    %{
      name: "yawlSMSInvoker",
      ...
      known_issues: [],
      start_iteration: 129, complete_iteration: 135,
      phase: :monitoring
    },
    ...
    %{
      ...
      known_issues: [],
      start_iteration: 136, complete_iteration: 148,
      phase: :integration
    },
    %{
      name: "balancer",
      ...
      start_iteration: 149, complete_iteration: 160,
      phase: :integration
    }
  ]
